	...
	execute: function(args) {
		...
		switch (args.execute.action) {
			...
			case 'moveTo':
				...
				actionMethod = 'moveTo';
				actionDescription = 'moving the ' + args.selector + ' to new coordinates.';
			...
			case 'switchTab':
				...
				actionMethod = 'log';
				actionDescription = 'current tab has been switched to selected index';
				actionArgs = ['browser'];
			...
			case 'closeTab':
				...
				actionMethod = 'log';
				actionDescription = 'current tab has been closed';
				actionArgs = ['browser'];
