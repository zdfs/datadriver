...
function buildChaiAssertString(modes) {
...
function executeProperties(args) {
	...
	args.actions.forEach(function(action, index) {
		...
		switch (actionKey) {
			...
			case "hover":
				...
				executeProperties(actionConfig);
...
drive = {
	...
	execute: function(args) {
		...
		switch (args.execute.action) {
			...
			case "sendKeystroke":
				...
				break;
			case "buttonDown":
				clickDesc = clickDescription(args.execute.button);
	...
	verifyCssProperty: function(args) {
		...
		it('the "' + args.assertKey + '" property of "' + args.selector + '" ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
	...
	verifyStoredCssProperty: function(args) {
		...
		it('the "' + args.assertKey + '" property of "' + args.selector + '" ' + buildChaiAssertString(args.mode) + ' the local storage value in key "' + originalAssertKey + '"', function(done) {
	...
	verifyText: function(args) {
		...
		it('the "' + args.selector + '" element\'s text ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
	...
	verifyAttribute: function(args) {
		...
		it('the "' + args.assertKey + '" attribute of "' + args.selector + '" ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
	...
	verifyUrl: function(args) {
		...
		it('the "' + args.assertKey + '" of this page is ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
	...
	verifyPageTitle: function(args) {
		...
		it('the "' + args.assertKey + '" of this page ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
	...
	verifyCount: function(args) {
		...
		it('the number of "' + args.selector + '" elements on the page ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
	...
	verifyScriptResult: function(args) {
		...
		it('evaluating "' + args.selector + '" returns a result that ' + buildChaiAssertString(args.mode) + ' "' + args.assert + '"', function(done) {
