	...
	execute: function(args) {
		...
		switch (args.execute.action) {
			...
			case 'switchTab':
				...
				actionMethod = 'log';
				actionDescription = 'Current tab has been switched to tab index "' + args.execute.focusIndex + '"';
				actionArgs = ['browser'];
			...
			case 'closeTab':
				...
				actionMethod = 'log';
				actionDescription = 'Tab was closed. New tab index is "' + args.execute.focusIndex + '".';
				actionArgs = ['browser'];
